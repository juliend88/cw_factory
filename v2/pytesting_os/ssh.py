...
ssh_connex.connect('84.39.37.80', username='cloud', key_filename='/home/dal/.ssh/alikey.pem', timeout=180)

chan_in, chan_out, chan_err = ssh_connex.exec_command("cat /etc/passwd | grep zzzzzz")
