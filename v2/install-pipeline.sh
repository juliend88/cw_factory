...
## Fedora
fly set-pipeline --target factory --config base-image-factory.yml --pipeline fedora-25 --load-vars-from credentials.yml -v OS_URL=http://fedora.mirrors.ovh.net/linux/releases/25/CloudImages/x86_64/images/Fedora-Cloud-Base-25-1.3.x86_64.qcow2 -v OS_NAME=fedora -v OS_VERSION=25
